...
// Treatment-specific long-form content
                      ...
                      <div key={region}>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2">
                          {cities.map(city => (
                            <Link
                              key={city}
                              href={`/locations/${toSlug(city)}/${service.slug}/`}
                ...
                <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                  ...
                  <div className="space-y-2">
                    {relatedServices.map(s => (
                      <Link key={s.id} href={`/treatments/${s.slug}/`} className="flex items-center gap-2 text-sm text-gray-600 hover:text-brand-600 transition-colors">
