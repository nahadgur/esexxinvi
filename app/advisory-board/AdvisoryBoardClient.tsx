  ...
  return (
    <>
      ...
      <section className="bg-gray-900 text-white py-16 relative overflow-hidden">
        ...
        <img src="/images/advisory-board/hero-board-meeting.webp" alt="" aria-hidden="true" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.18 }} />
