...
//
// PUBLIC ADVISORY BOARD LISTING — /advisory-board/
//
// Linked from:
//   - Every MedicallyReviewedBy component (reviewer name links here)
//   - /editorial-policy/ page
//   - Site footer
//
// E-E-A-T function: Provides the "named responsible humans" layer that
// Google Quality Raters look for on YMYL sites. An anonymous directory
// scores poorly on trustworthiness — named, GDC-verifiable reviewers
// with publicly visible bios elevate the site from "aggregator" to
// "consumer advocacy institution".
          ...
          <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-700">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p>Every member's GDC registration number is listed below. You can verify their registration status at any time at <a href={gdcCheckUrl} target="_blank" rel="noopener noreferrer" className="text-brand-700 underline">gdc-uk.org</a>.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-12">
              {members.map(member => (
                <div
                  key={member.slug}
                  id={member.slug}
                  className="grid md:grid-cols-4 gap-8 border border-gray-200 rounded-2xl p-8"
                >
                  {/* Avatar + credentials */}
                  <div className="md:col-span-1 flex flex-col items-center text-center">
                    {member.avatarUrl ? (
                      <img
                        ...
                        alt={member.name}
                        className="w-28 h-28 rounded-full object-cover border-4 border-brand-100 mb-4"
                      />
                    ) : (
                    ...
                    {/* GDC number — linked to verification tool */}
                    <a
                      href={gdcCheckUrl}
                      target="_blank"
                  ...
                  <div className="md:col-span-3">
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      <span className="text-xs bg-gray-100 border border-gray-200 text-gray-600 rounded-full px-3 py-1">
                        Conflict declaration: {member.conflictDeclarationYear}
                      </span>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 text-xs text-gray-500">
                      Reviews content on: {member.reviewedTreatments.map(t =>
      ...
      <section className="py-12 bg-gray-50 border-t border-gray-200">
        <div className="container-width max-w-2xl text-center">
          ...
          <p className="text-gray-600 mb-6">
            We periodically expand our Advisory Board. Board members receive a fixed advisory fee for periodic content review and are publicly credited on reviewed pages. There is no requirement to refer patients or promote the directory.
          </p>
          <Link
            href="/contact/?subject=Advisory+Board+Enquiry"
