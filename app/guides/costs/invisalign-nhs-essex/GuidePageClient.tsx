        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '48px' }}>
              ...
              <p style={pStyle}>
                A common mistake is assuming you need Comprehensive when Express or Lite is clinically appropriate. An honest, experienced provider will recommend the product your case actually requires, not the most expensive option available. This is one reason choosing a verified Platinum-tier provider matters: their higher case volumes mean they have experience with the full range of products and can advise accurately.
              </p>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                Our directory covers 12 Essex catchments, with local pricing data and verified provider tiers for each. Use the links below to see which verified Platinum-tier providers are available near you, what they charge for your treatment type, and how quickly you can get seen.
              </p>
              ...
              <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '24px', margin: '28px 0' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--muted)', marginBottom: '16px' }}>
                  Or use our free matching service. We send your details to up to 3 verified Platinum-tier providers near you. Free consultations, free 3D scans, written quotes at no obligation.
                </p>
                <button
          ...
          <aside style={{ position: 'sticky', top: '88px', height: 'fit-content', display: 'flex', flexDirection: 'column', gap: '20px' }} className="guide-sidebar">
            ...
            <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '20px', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--muted)', marginBottom: '16px', lineHeight: 1.6 }}>
                Compare verified Platinum-tier providers near you. Free consultation, free 3D scan.
              </p>
              <button
                onClick={() => setIsModalOpen(true)}
