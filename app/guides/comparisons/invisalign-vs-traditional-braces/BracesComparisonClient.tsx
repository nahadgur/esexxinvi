        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '48px' }}>
              ...
              <p style={pStyle}>
                For the majority of adult orthodontic presentations (crowding, spacing, overbite, underbite, crossbite within the dental range) Invisalign in the hands of a verified Platinum-tier provider can achieve equivalent clinical results to fixed braces. This is not marketing; it is the documented consensus of the orthodontic literature over the past decade.
              </p>
              <p style={pStyle}>
              ...
              <p style={pStyle}>
                The honest position: if a verified Platinum-tier Invisalign provider tells you at consultation that your case is better treated with fixed appliances, that is a clinically significant recommendation, not a sales failure. Experienced providers refer out when it is in the patient's interest to do so.
              </p>
            </section>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                Every verified Platinum-tier provider in our Essex directory offers a free initial consultation, including a full iTero 3D scan and a written treatment recommendation. If Invisalign is appropriate for your case, you will see a ClinCheck simulation of the result. If fixed braces would serve you better, an experienced provider will tell you so and explain why.
              </p>
              <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '24px', margin: '28px 0' }}>
                <p style={{ fontSize: '15px', fontWeight: 600, color: 'var(--ink)', marginBottom: '8px' }}>Compare verified Platinum-tier providers in Essex</p>
                <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '20px' }}>
                  Browse our verified clinic directory. Every listed provider holds Platinum-tier (or higher) status with Align Technology and is rated 4.5 stars or above by verified patients.
                </p>
