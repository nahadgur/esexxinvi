        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                The majority of verified Platinum-tier Invisalign providers in Essex offer 0% interest finance plans. A £3,000 treatment over 24 months at 0% APR is £125 per month. The cost barrier that mail-order aligners appear to remove is largely addressed by finance, without any of the clinical risk.
              </p>
              <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '24px', margin: '28px 0' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '20px' }}>
                  Every provider in our Essex directory is GDC-registered, holds verified Platinum-tier Invisalign status (or higher) with Align Technology, and offers a free initial consultation with a full iTero 3D scan. 0% finance is available at the majority of listed clinics. No obligation to proceed.
                </p>
