        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '48px' }}>
              ...
              <p style={pStyle}>
                The good news: the major commuter corridors from London are also among the highest concentrations of verified Platinum-tier Invisalign providers in the county. Here is the commuter landscape across the key Essex hubs:
              </p>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                Use our directory to find verified Platinum-tier providers in the Essex commuter towns closest to you. Each location page shows the clinics available, their opening hours, and how to book a free initial consultation.
              </p>
