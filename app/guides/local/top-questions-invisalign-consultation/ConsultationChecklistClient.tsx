...
const questions = [
  {
    ...
    detail: `Align Technology certifies Invisalign providers at several tiers based on how many cases they complete each year. Tiers above Gold include Platinum (150+ cases per year), Platinum Elite, Diamond (300+ cases per year), and Diamond Apex. Providers at Platinum and above plan and manage Invisalign cases routinely. They have seen the complications, the tracking failures, the challenging rotations. They know how to handle them.

A Gold provider completes around 20 cases per year. That is fewer than two per month. A general dentist who offers Invisalign alongside fillings, hygiene, and routine NHS appointments may be perfectly competent at straightforward cases, but they are not exposed to enough clinical complexity to develop the troubleshooting expertise that higher-tier providers accumulate naturally.
...
Ask the question directly: "What is your current Invisalign tier, and can you confirm it?" The answer should be immediate and specific. If there is hesitation, or if the response is "we are registered with Invisalign" rather than a named tier, that tells you something.`,
    ...
    greenFlag: 'Platinum tier (or higher) confirmed immediately and without prompting.',
  },
  {
    n: 2,
...
Ask: "Can I see my ClinCheck simulation today, as part of the free consultation?" The 3D scan is taken at the consultation precisely so that a preliminary ClinCheck can be generated. You should leave the appointment having seen at minimum a preliminary simulation of your proposed outcome.`,
  ...
  },
  {
    ...
    detail: `Most verified Platinum-tier providers in Essex offer some form of finance. The terms vary considerably: 0% APR over 12 to 24 months is the most advantageous option for patients with good credit history. Interest-bearing plans at 9.9% to 14.9% APR over 36 to 60 months are available for patients who need lower monthly payments or have a lower credit score, but these increase the total amount paid.
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                Asking the right questions matters, but you can reduce the risk considerably by starting with a provider who has already been vetted against objective criteria. Every clinic in our Essex directory holds verified Platinum-tier status (or higher) confirmed against Align Technology records, not self-reported, maintains a 4.5-star or above Google rating from verified patients, and is GDC-registered.
              </p>
              <p style={pStyle}>
              ...
              <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '24px', margin: '28px 0' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '20px' }}>
                  Every listed clinic is verified Platinum-tier (or higher), GDC-registered, and rated 4.5 stars or above. Verified, transparent, and offering free consultations.
                </p>
          ...
          <aside style={{ position: 'sticky', top: '88px', height: 'fit-content', display: 'flex', flexDirection: 'column', gap: '20px' }} className="guide-sidebar">
            ...
            <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '20px', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--muted)', marginBottom: '16px', lineHeight: 1.6 }}>Verified Platinum-tier. GDC-registered. 4.5 stars+. Free consultation.</p>
