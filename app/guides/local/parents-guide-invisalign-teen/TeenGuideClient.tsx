        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                The majority of verified Platinum-tier Invisalign providers in our Essex network offer 0% interest finance plans that spread the cost over 12 to 36 months. A £3,500 treatment over 24 months at 0% APR is approximately £146 per month, less than many families spend on after-school activities, and considerably less than a Saturday morning activity class and extracurricular sports combined.
              </p>
              <p style={pStyle}>
              ...
              <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '24px', margin: '28px 0' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '20px' }}>
                  Our directory covers 12 Essex catchments. Use the links below to find verified Platinum-tier providers near you who work with teen patients and offer flexible finance options.
                </p>
