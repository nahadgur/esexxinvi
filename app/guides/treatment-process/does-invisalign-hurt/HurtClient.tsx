            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <div style={{ background: 'var(--sage-pale)', border: '1px solid #c8d9c9', borderRadius: '12px', padding: '24px', margin: '28px 0' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '20px' }}>
                  Every clinic in our directory holds verified Platinum-tier Invisalign status (or higher) with Align Technology and is rated 4.5 stars or above by verified patients. Browse the directory to read patient reviews and find a provider who will monitor your comfort throughout treatment.
                </p>
