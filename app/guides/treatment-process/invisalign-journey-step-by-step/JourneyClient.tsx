        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '56px', maxWidth: '1100px', margin: '0 auto', padding: 'clamp(40px,5vw,64px) clamp(24px,5vw,56px)' }} className="guide-grid">
          ...
          <article style={{ minWidth: 0 }}>
            ...
            <section style={{ marginBottom: '32px' }}>
              ...
              <p style={pStyle}>
                Every verified Platinum-tier Invisalign provider in our Essex network offers a free initial consultation that includes a full iTero 3D scan and a ClinCheck preview of your proposed treatment. You see what your finished smile looks like before you make any decision. There is no obligation to proceed.
              </p>
              <p style={pStyle}>
