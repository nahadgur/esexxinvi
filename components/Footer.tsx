        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-brand-500 rounded-md flex items-center justify-center text-white font-bold">IE</div>
              <span className="font-display font-bold text-lg text-white">Invisalign Essex</span>
            </div>
            ...
            <p className="text-xs text-gray-500 italic border-l-2 border-gray-700 pl-3">
              Invisalign Essex is a referral facilitator. We connect you with independent dental professionals. We do not perform treatment ourselves.
            </p>
          </div>
